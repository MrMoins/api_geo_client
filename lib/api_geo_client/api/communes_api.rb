...
module ApiGeoClient
  class CommunesApi
    ...
    # @return [Array<(Commune, Integer, Hash)>] Commune data, response status code and response headers
    def communes_code_get_with_http_info(code, opts = {})
      ...
      return_type = opts[:return_type] || 'Commune' 
    ...
    def epcis_code_communes_get_with_http_info(code, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CommunesApi.epcis_code_communes_get ...'
      end
      # verify the required parameter 'code' is set
      if @api_client.config.client_side_validation && code.nil?
        fail ArgumentError, "Missing the required parameter 'code' when calling CommunesApi.epcis_code_communes_get"
      end
      if @api_client.config.client_side_validation && opts[:'fields'] && !opts[:'fields'].all? { |item| ['nom', 'code', 'codesPostaux', 'siren', 'centre', 'surface', 'contour', 'mairie', 'bbox', 'codeEpci', 'epci', 'codeDepartement', 'departement', 'codeRegion', 'region', 'population', 'zone'].include?(item) }
        fail ArgumentError, 'invalid value for "fields", must include one of nom, code, codesPostaux, siren, centre, surface, contour, mairie, bbox, codeEpci, epci, codeDepartement, departement, codeRegion, region, population, zone'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommunesApi#epcis_code_communes_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
